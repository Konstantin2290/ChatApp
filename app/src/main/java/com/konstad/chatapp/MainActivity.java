...
public class MainActivity extends AppCompatActivity {
    ...
    private StorageReference referenceToImages;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //referenceToImages = storageRef.child("images");
    ...
    private void sendMessage(String textOfMessage, String ulrToImage){
        ...
        } else if(ulrToImage != null && !ulrToImage.isEmpty()) {
            message = new Message(author, null, System.currentTimeMillis(), ulrToImage);
        }
        assert message != null;
